...
public class MainBottomTabLayout extends LinearLayout {
    ...
    private int mTitles[] = {R.string.tab_name_design_pattern, R.string.tab_name_multi_thread, R.string.tab_name_ui, R.string.tab_name_performance };
    private int mIconRes[][] = {
            {R.mipmap.office, R.mipmap.office_full},
            {R.mipmap.office_project, R.mipmap.office_project_full},
            {R.mipmap.shortcut, R.mipmap.shortcut_full},
            {R.mipmap.office_news, R.mipmap.office_news_full},
    };
